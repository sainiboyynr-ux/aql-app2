...
export default function Dashboard({ profile, onStartNew, onOpenDraft }) {
  ...
  const decBadge = (dec) => {
    ...
    return (
      <span style={{ fontSize: '10px', fontWeight: '700', padding: '3px 10px', borderRadius: '20px', background: m.bg, color: m.color, border: `1px solid ${m.border}`, letterSpacing: '0.04em' }}>
        {dec}
      </span>
    )
  }
    ...
    <div style={s.wrap}>
      ...
      <div style={s.welcomeBanner}>
        ...
        <div style={s.welcomeText}>
          ...
          <div style={s.welcomeSub}>Ready to start an AQL inspection?</div>
        </div>
      ...
      <div style={s.rulesStrip}>
        <div style={s.ruleItem}>
          <span style={{ ...s.ruleDot, background: '#C0395A' }} />
          <span>Critical = 0%</span>
        </div>
        <div style={s.ruleDivider} />
        <div style={s.ruleItem}>
          <span style={{ ...s.ruleDot, background: '#B8860B' }} />
          <span>Major ≤ 1%</span>
        </div>
        <div style={s.ruleDivider} />
        <div style={s.ruleItem}>
          <span style={{ ...s.ruleDot, background: '#0F7B6C' }} />
          <span>Minor ≤ 4%</span>
        </div>
      </div>
...
const s = {
  ...
  welcomeIcon:    { fontSize: '32px', zIndex: 1 },
  statGrid:       { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '12px' },
  statCard:       { borderRadius: '14px', padding: '14px 16px', boxShadow: '0 4px 14px rgba(0,0,0,0.12)', position: 'relative', overflow: 'hidden' },
  ...
  bigBtnIcon:     { fontSize: '28px', color: '#fff', fontWeight: '300', lineHeight: 1 },
  ...
  listIcon:       { fontSize: '20px', flexShrink: 0 },
