...
export function generatePDF(inspection, inspectorName) {
  ...
  function drawHeader() {
    ...
    doc.text('BEAUTYSUREAQL', 105, 13, { align: 'center' })
    doc.setFontSize(10).setFont('helvetica', 'normal')
    doc.text('Finished Goods AQL Inspection Report', 105, 21, { align: 'center' })
    doc.text('Ref: BSAQL-QA-SOP-22-F-02  |  ISO 2859-1 General Inspection Level II', 105, 28, { align: 'center' })
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    doc.text(
      `BSAQL-QA-SOP-22-F-02  |  Generated: ${new Date().toLocaleString('en-IN')}  |  Page ${i} of ${pageCount}`,
